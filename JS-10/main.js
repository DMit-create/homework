...
// Проверка
// console.log(typeof firstName, typeof lastName, typeof isStudent);
...
console.log(
	`Меня зовут ${firstName} ${lastName}, я ${birthYear} года рождения и мне ${age} лет. Я ученик курса: ${isStudent}`,
);
// console.log(typeof firstName, typeof lastName, typeof age, typeof isStudent);
