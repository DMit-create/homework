...
alert("ЗАДАЧА 1. Чётное число / нечётное число");
...
console.log(`Скидка ${discountSwitch}%`);
...
alert("ЗАДАЧА 4. Доставка");
const weight = Number(prompt("Укажите вес посылки"));
...
const totalCost = basePrice * coefficient;
